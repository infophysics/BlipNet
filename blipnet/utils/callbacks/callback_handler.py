...
from blipnet.utils.callbacks import GenericCallback
from blipnet.utils.utils import get_method_arguments
...
class CallbackHandler:
    ...
    def collect_callbacks(self):
        ...
        self.callback_files.extend(self.meta['local_blipnet_files'])
    ...
    def add_callback(
        ...
        if issubclass(type(callback), GenericCallback):
            ...
            self.logger.error(
                ...
                ' be used by the callbackHandler in blipnet.'
            )
