...
from blipnet.module import GenericModule
from blipnet.module.common import module_aliases
...
class ModuleHandler:
    ...
    def collect_modules(self):
        ...
        self.module_files.extend(self.meta['local_blipnet_files'])
    ...
    def add_module(
        ...
        if issubclass(type(module), GenericModule):
            ...
            self.logger.error(
                ...
                ' be used by the ModuleHandler in blipnet.'
            )
